...
import { Link, Alert, Typography, Box, Flex, useCallbackRef, useComposedRefs, Field, Toggle, Checkbox, DatePicker, DateTimePicker, TextInput, SingleSelect, SingleSelectOption, JSONInput, NumberInput, Textarea, TimePicker, Popover, Button, EmptyStateLayout, Loader } from "@strapi/design-system";
...
const Editor = ({ field, name: name2 }) => {
    ...
    if (toolpackError !== null) {
      return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(
        EmptyStateLayout,
        {
          ...
          action: /* @__PURE__ */ jsx(Typography, { textAlign: "center", variant: "pi", children: toolpackError })
        }
      ) });
    } else if (tools === null) {
      return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(Flex, { alignItems: "center", justifyContent: "center", direction: "column", paddingTop: 6, paddingBottom: 6, children: [
        /* @__PURE__ */ jsx(Loader, { small: true }),
        /* @__PURE__ */ jsx(Typography, { variant: "epsilon", children: "Loading Toolpack..." })
      ] }) });
    } else {
      return /* @__PURE__ */ jsx(ActualEditor, {});
    }
  };
  const ActualEditor = () => {
    if (tools === null) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { style: { border: `1px solid rgb(227, 233, 243)`, borderRadius: `2px`, marginTop: `4px` }, children: renderEditor() }),
    /* @__PURE__ */ jsx(
      MediaLibComponent,
      {
...
const Wysiwyg = ({
  ...
  const field = useField(name2);
  /* @__PURE__ */ jsx(Field.Root, { name: name2, hint, error: field.error, required, children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 1, children: [
    /* @__PURE__ */ jsx(Field.Label, { action: labelAction, children: label }),
    /* @__PURE__ */ jsx(Editor, { field, name: name2, disabled }),
    /* @__PURE__ */ jsx(Field.Hint, {}),
    /* @__PURE__ */ jsx(Field.Error, {})
  ] }) });
};
